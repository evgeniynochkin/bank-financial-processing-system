    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        if (true) {
            ...
            http.csrf().ignoringAntMatchers("/bank/*")
                    ...
                    .ignoringAntMatchers("/infoAccount")
                    .ignoringAntMatchers("/withdrawCash")
                    .ignoringAntMatchers("/updateDeposit")
                    .ignoringAntMatchers("/erorr")
                    .ignoringAntMatchers("/createAnAccount")
                    .and()
                    .authorizeRequests()
                    .antMatchers("/pos/pay").hasAnyRole("MANAGER")
                    .and()
                    .authorizeRequests()
//                    .antMatchers("/createAnAccount").hasAnyRole("MANAGER","ADMIN")
